...
public interface IDirectXCOMObject: IUnknownWrapper {
	internal static abstract TInterface Instantiate< TInterface >( )
								where TInterface: IDirectXCOMObject ;
	...
	/// </remarks>
	void GetPrivateData< TData >( out uint pDataSize, nint pData ) 
...
public interface IDirectXWrapper< T >: IDirectXCOMObject,
