...
/// </remarks>
public class PerformanceException: DXSharpException {
	/// <summary>
	/// Creates a new PerformanceException with the specified exception message
	/// </summary>
	/// <param name="message">Exception message</param>
	public PerformanceException( string? message = null ): 
		base( message! ) { }
	...
	public PerformanceException( string? message, Exception innerException ): 
