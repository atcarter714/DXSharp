...
public interface IDevice: IObject, IUnknownWrapper< ID3D12Device > {
	...
	//static abstract TInterface IDXCOMObject.Instantiate< TInterface >( ) ;
	...
	void CreateCommandAllocator( CommandListType type, in Guid riid,
		...
		unsafe { fixed ( Guid* riidPtr = &riid ) {
				...
				IDXCOMObject.Instantiate< ICommandAllocator >( ) ;
			}
		}
	}
	...
	/// <para><see href="https://docs.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12device-createplacedresource#parameters">
	...
	/// for your app.
	/// </para>
	/// <para><see href="https://docs.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12device-createplacedresource#">
	/// Read more on docs.microsoft.com</see>.</para>
	/// </remarks>
