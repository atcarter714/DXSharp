...
public struct D3D12Options: IFeatureData<D3D12Options> {
	/// <summary>
...
public struct D3D12Options1: IFeatureData<D3D12Options1> {
...
public struct D3D12Options2: IFeatureData<D3D12Options2> {
	/// <summary>
...
public struct D3D12Options3: IFeatureData<D3D12Options3> {
...
public struct D3D12Options4: IFeatureData<D3D12Options4> {
...
public struct D3D12Options5: IFeatureData<D3D12Options5> {
...
public struct D3D12Options6: IFeatureData<D3D12Options6> {
...
public struct D3D12Options7: IFeatureData<D3D12Options7> {
	/// <summary>
...
public struct D3D12Options8: IFeatureData<D3D12Options8> {
	/// <summary>
...
public struct D3D12Options9: IFeatureData<D3D12Options9> {
...
public struct D3D12Options10: IFeatureData<D3D12Options10> {
	/// <summary>
...
public struct D3D12Options11: IFeatureData<D3D12Options11> {
