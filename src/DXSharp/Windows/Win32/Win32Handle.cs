...
public readonly partial struct Win32Handle {
	...
	public static implicit operator Win32Handle( ComPtr           value )  => new( value.Address ) ;
	public static implicit operator ComPtr( Win32Handle           handle ) => new( handle.Value ) ;
	public static implicit operator Win32Handle( ComPtr<IUnknown> value )  => new( value.Address ) ;
