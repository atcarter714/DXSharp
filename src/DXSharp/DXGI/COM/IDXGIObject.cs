...
public unsafe interface IDXGIObject: IUnknown {
	...
	/// </remarks>
	void SetPrivateData( Guid* Name, uint DataSize, void* pData ) ;
	...
	/// </remarks>
	void SetPrivateDataInterface( Guid* Name, [MarshalAs(0x19)] IUnknown pUnknown ) ;
	...
	/// </remarks>
	void GetPrivateData( Guid* Name, ref uint pDataSize, void* pData ) ;
