...
public interface IDXGIDecodeSwapChain: IUnknown {
	...
	/// </remarks>
	unsafe void SetSourceRect( Rect* pRect ) ;
	...
	/// </remarks>
	unsafe void SetTargetRect( Rect* pRect ) ;
	...
	/// </remarks>
	unsafe void GetSourceRect( Rect* pRect ) ;
	...
	/// </remarks>
	unsafe void GetTargetRect( Rect* pRect ) ;
	...
	/// </remarks>
	[PreserveSig] MultiplaneOverlayYCbCrFlags GetColorSpace( ) ;
} ;
