...
/// <summary>
/// This interface controls the debug information queue,
/// and can only be used if the debug layer is turned on.
/// </summary>
[SupportedOSPlatform( "windows8.0" )]
[ProxyFor(typeof(IDXGIInfoQueue))]
public interface IInfoQueue: IComIID, IInstantiable {
	// ---------------------------------------------------------------------------
	//! Creation Functions ::
	internal static readonly ReadOnlyDictionary< Guid, Func<IDXGIInfoQueue, IInstantiable> > _infoQueueCreationFunctions =
		new( new Dictionary<Guid, Func<IDXGIInfoQueue, IInstantiable> > {
			{ IInfoQueue.IID, ( pComObj ) => new InfoQueue( pComObj ) },
		} ) ;
	// ---------------------------------------------------------------------------
	...
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setmessagecountlimit#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-clearstoredmessages#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getmessage#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void GetMessage( Guid                            Producer,
					 ulong                           MessageIndex,
					 ref           nuint             pMessageByteLength,
					 [Optional] in InfoQueueMessage? pMessage ) ;
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnumstoredmessagesallowedbyretrievalfilters#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnumstoredmessages#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnummessagesdiscardedbymessagecountlimit#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getmessagecountlimit#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnummessagesallowedbystoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnummessagesdeniedbystoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addstoragefilterentries#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void AddStorageFilterEntries( Guid Producer, in Span< InfoQueueFilter > pFilter ) ;
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getstoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void GetStorageFilter( Guid Producer,
								  ref nuint pFilterByteLength,
										[Optional] in Span< InfoQueueFilter > pFilter ) ;
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-clearstoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushemptystoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushdenyallstoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushcopyofstoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushstoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void PushStorageFilter( Guid Producer, in InfoQueueFilter pFilter  ) ;
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-popstoragefilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getstoragefilterstacksize#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addretrievalfilterentries#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void AddRetrievalFilterEntries( Guid Producer,
									in InfoQueueFilter pFilter ) ;
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getretrievalfilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void GetRetrievalFilter( Guid Producer,
								ref nuint pFilterByteLength,
									[Optional] in InfoQueueFilter? pFilter ) ;
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-clearretrievalfilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushemptyretrievalfilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushdenyallretrievalfilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushcopyofretrievalfilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushretrievalfilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void PushRetrievalFilter( Guid Producer, in InfoQueueFilter pFilter ) ;
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-popretrievalfilter#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getretrievalfilterstacksize#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addmessage#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	void AddMessage( Guid                     Producer, 
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addapplicationmessage#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setbreakoncategory#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setbreakonseverity#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setbreakonid#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getbreakoncategory#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getbreakonseverity#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getbreakonid#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setmutedebugoutput#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para><div class="alert"><b>Note</b>  This API requires the Windows Software Development Kit (SDK) for Windows 8.</div> <div> </div></para>
	/// <para><a href="https://docs.microsoft.com/windows/win32/api/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getmutedebugoutput#">Read more on docs.microsoft.com</a>.</para>
	/// </remarks>
	...
	static ref readonly Guid IComIID.Guid  {
		...
		get {
			ReadOnlySpan< byte > data = typeof(IDXGIInfoQueue).GUID
															  .ToByteArray( ) ;
	...
	static IInstantiable IInstantiable.Instantiate( ) => new InfoQueue( ) ;
	static IInstantiable IInstantiable.Instantiate( nint ptr ) => new InfoQueue( ptr ) ;
	static IInstantiable IInstantiable.Instantiate< ICom >( ICom pComObj ) => new InfoQueue( (pComObj as IDXGIInfoQueue)! ) ;
	// ===========================================================================
} ;
