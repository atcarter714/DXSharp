...
/// </remarks>
public interface IOutputDuplication: IObject, DXGIWrapper< IDXGIOutputDuplication > {
			//! TODO: Find out why these get generated as `new` and hide the base versions ...
			/*void SetPrivateData( Guid* Name, uint DataSize, void* pData ) ;
			void SetPrivateDataInterface( Guid* Name, object pUnknown ) ;
			void GetPrivateData( Guid* Name, ref uint pDataSize, void* pData ) ;
			void GetParent( Guid* riid, out object ppParent ) ;*/
