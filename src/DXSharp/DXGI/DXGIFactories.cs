...
public class Factory: Object, IFactory {
	Factory( IntPtr address ): base( address ) { }
	Factory( IDXGIFactory factory ):
		base( Marshal.GetIUnknownForObject(factory) ) { }
	
	protected IDXGIFactory? _dxgiFactory ;
	protected IDXGIFactory? _dxgiFactoryFetch => _dxgiFactory ??=
		Marshal.GetObjectForIUnknown( this.Pointer ) as IDXGIFactory ;
