...
/// </summary>
//internal interface IFactory: IObject
//{
...
//	/// </remarks>
//	internal HRESULT EnumAdapters( uint index, out IAdapter ppAdapter );
...
//	/// </remarks>
//	internal void MakeWindowAssociation( HWND WindowHandle, MWAFlags Flags );
...
//	/// </remarks>
//	internal HRESULT CreateSwapChain( object pDevice, in SwapChainDescription pDesc, out ISwapChain ppSwapChain );
...
//	/// </remarks>
//	internal void CreateSoftwareAdapter( HINSTANCE Module, out IAdapter ppAdapter );

//};

//internal class Factory: Object, IFactory
//{
