...
public interface IDXGIObject: IUnknown {
	...
	/// <para><see href="https://docs.microsoft.com/windows/win32/api/dxgi/nf-dxgi-idxgiobject-setprivatedata#">Read more on docs.microsoft.com</see>.</para>
	/// </remarks>
	...
	/// <para><see href="https://docs.microsoft.com/windows/win32/api/dxgi/nf-dxgi-idxgiobject-setprivatedatainterface#">Read more on docs.microsoft.com</see>.</para>
	/// </remarks>
	unsafe void SetPrivateDataInterface( Guid* Name, [MarshalAs(0x19)] object pUnknown ) ;
	...
	/// </remarks>
	unsafe void GetParent( Guid* riid, [MarshalAs(0x19)] out object ppParent ) ;
